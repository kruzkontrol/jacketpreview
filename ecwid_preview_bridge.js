...
(function () {
  ...
  function send() {
    ...
    try {
      ...
      tag.textContent = "preview v14V"
        + " | color: " + (values.jacket || "(none)")
        + " | customize: " + (values.stole_on || "(none)")
        + " | TL: " + (values.stole_tl || "(empty)")
        + " | BL: " + (values.stole_bl || "(empty)")
        + " | TR: " + (values.stole_tr || "(empty)")
        + " | BR: " + (values.stole_br || "(empty)");
    } catch (e) {}
